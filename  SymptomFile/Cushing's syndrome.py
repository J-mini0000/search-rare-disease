...
#쿠싱증후군
html = urlopen("https://terms.naver.com/entry.naver?docId=6043716&cid=51362&categoryId=51362") #희귀질환정보(뇌하수체-의존 부신피질기능항진증)
...
with open("C:/Users/hw499/PycharmProjects/CapstoneDesign/ SymptomFile/Cushing's syndrome symptomIFile.txt", "w", encoding='UTF=8') as symptomIFile:
    for text in a:
